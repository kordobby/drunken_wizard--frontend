...
const SignUp = () => {
  ...
  const [nickFocus, setNickFocus] = useFocusHandler<boolean>(false);
  const [emailFocus, setEmailFocus] = useFocusHandler<boolean>(false);
  const [pwFocus, setPwFocus] = useFocusHandler<boolean>(false);
  const [pwCheckFocus, setPwCheckFocus] = useFocusHandler<boolean>(false);
